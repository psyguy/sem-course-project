...
anxiety.1 =~ 1*anxious.1 + dou.anxiety*doubt.1 + gui.anxiety*guilty.1 + lon.anxiety*lonely.1 + sus.anxiety*suspic.1 + wor.anxiety*worry.1 
 
 selfcon.1 =~ 1*ashamed.1 + lon.selfcon*lonely.1 + gui.selfcon*guilty.1 + sel.selfcon*selfdoub.1 + wor.selfcon*worry.1 
 
 somatiz.1 =~ 1*drymouth.1 + hea.somatiz*headache.1 + sle.somatiz*sleepy.1 + tir.somatiz*tired.1 
 
 posacti.1 =~ 1*cheerf.1 + con.posacti*concent.1 + enj.posacti*enjoy.1 + ent.posacti*enthus.1 + rel.posacti*relaxed.1 + sat.posacti*satisfi.1 + str.posacti*strong.1 
 
 negacti.1 =~ 1*agitate.1 + dow.negacti*down.1 + irr.negacti*irritat.1 + res.negacti*restl.1 + sle.negacti*sleepy.1
